export const taskChances = {
  ...
  randomEvents: {
    foundMoney: 0.003, // Chance to find spare cash
    sprainedAnkle: 0.002, // Chance to sprain your ankle
    taxRefund: 0.001,
    inheritanceGift: 0.001,
    lotteryPrize: 0.001,
    freelanceBonus: 0.001,
    yardSaleProfit: 0.001,
    cashBackReward: 0.001,
    investmentDividend: 0.001,
    refundCheck: 0.001,
    soldOldStuff: 0.001,
    birthdayMoney: 0.001,
    rebateCheck: 0.001,
    creditCardPoints: 0.001,
    carpoolSavings: 0.001,
    scholarshipAward: 0.001,
    grantReceived: 0.001,
    gameShowWin: 0.001,
    lawsuitSettlement: 0.001,
    overtimePay: 0.001,
    neighborRepayment: 0.001,
    classActionPayout: 0.001,
    cryptoGain: 0.001,
    stockSplit: 0.001,
    cashTips: 0.001,
    sideGigIncome: 0.001,
    ...
    homeRepairs: 0.001,
    dentedCar: 0.001,
    charityPressure: 0.001,
    theftVictim: 0.001,
    applianceReplacement: 0.001,
    utilitySpike: 0.001,
    insuranceDeductible: 0.001,
    lawsuitFees: 0.001,
    vehicleTowing: 0.001,
    subscriptionRenewal: 0.001,
    loanInterest: 0.001,
    lostBet: 0.001,
    failedInvestment: 0.001,
    friendBorrowed: 0.001,
    spaDay: 0.001,
    healthyMeal: 0.001,
    jogInPark: 0.001,
    yogaSession: 0.001,
    doctorCheckup: 0.001,
    vitaminBoost: 0.001,
    massageTherapy: 0.001,
    meditationRetreat: 0.001,
    earlyNightSleep: 0.001,
    natureHike: 0.001,
    gymAchievement: 0.001,
    fluShot: 0.001,
    dentalCleaning: 0.001,
    beachVacation: 0.001,
    laughterTherapy: 0.001,
    quitSmoking: 0.001,
    hydrationKick: 0.001,
    newBike: 0.001,
    stretchingRoutine: 0.001,
    stressFreeWeek: 0.001,
    danceClass: 0.001,
    farmersMarket: 0.001,
    groupSport: 0.001,
    petTherapy: 0.001,
    ...
    caughtFlu: 0.001,
    foodPoisoning: 0.001,
    minorCarAccident: 0.001,
    overworked: 0.001,
    allergicReaction: 0.001,
    sunburn: 0.001,
    slippedDisc: 0.001,
    coldSnap: 0.001,
    hangover: 0.001,
    ...
    dehydration: 0.001,
    lateNightOut: 0.001,
    stressFracture: 0.001,
    minorSurgeryRecovery: 0.001,
    toothache: 0.001,
    insomnia: 0.001,
    foodAllergy: 0.001,
    kneePain: 0.001,
